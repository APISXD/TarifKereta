...
document.getElementById("jenisKereta").addEventListener("change", function() {
 ...
 document.getElementById("submitBtn").addEventListener("click", function() {
    ...
    if (jenisKereta === "KRL") {
        var hasilAkses = saldo >= 5000 ? "Akses KRL diizinkan" : "Saldo tidak mencukupi untuk masuk KRL";
        hasilAksesDiv.innerHTML = hasilAkses;

        // Saldo akhir jika hanya menggunakan KRL
        var saldoAkhir = saldo - (hasilAkses === "Akses KRL diizinkan" ? tarifKRL : 0);
        ...
        if (saldoAkhirKRL < 14000) {
            hasilAksesDiv.innerHTML = "Saldo tidak mencukupi untuk melanjutkan ke MRT";
            return;
        }
